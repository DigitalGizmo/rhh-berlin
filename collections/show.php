...
<div class="collection-description">
	<?php echo ($d=metadata('collection',array('Dublin Core','Description'))) ? $d : null; // Erin added ?>
</div>

<?php //echo all_element_texts('collection'); // Erin removed ?>

<div id="collection-items">
    <h2><?php echo __('Contributed Items'); ?></h2>
    <?php if ($totalItems > 0): ?>
